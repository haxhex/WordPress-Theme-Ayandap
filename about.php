...
<div id="content">
    ...
    <div class="about-content">
        <h2 style="font-weight: normal;">درباره ما</h2>
        <p>سایت "آینداپ" سایتی جامع در زمینه‌ی توسعه‌ی اینترنت اشیا، ساخت گیم، تکنولوژی، و نرم‌افزار است. با استفاده از سرویس های ما، به دنیایی از فناوری و سرگرمی وارد شوید.</p>
    </div>
