...
<body <?php body_class(); ?>>
  ...
  <defs>
    ...
    <linearGradient id="linear-gradient-12" x1="0.192" y1="0.488" x2="0.802" y2="0.509" gradientUnits="objectBoundingBox">
      <stop offset="0" stop-color="#5d5bf2"/>
      <stop offset="1" stop-color="#3c27d3"/>
    </linearGradient>
    <linearGradient id="linear-gradient-13" x1="0.629" y1="0.272" x2="0.186" y2="1.334" gradientUnits="objectBoundingBox">
    ...
    <linearGradient id="linear-gradient-14" x1="0.796" y1="0.164" x2="2.06" y2="-1.26" gradientUnits="objectBoundingBox">
      <stop offset="0" stop-color="#3c27d3"/>
    ...
    <linearGradient id="linear-gradient-15" x1="4.949" y1="-2.235" x2="16.693" y2="-9.44" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-16" x1="11.076" y1="-6.002" x2="37.193" y2="-22.07" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-17" x1="10.342" y1="-3.907" x2="161.061" y2="-71.399" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-18" x1="52.52" y1="-23.562" x2="302.81" y2="-139.336" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-19" x1="73.144" y1="-32.989" x2="323.399" y2="-148.36" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-20" x1="48.3" y1="-38.093" x2="237.748" y2="-191.049" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-21" x1="23.463" y1="-17.973" x2="213.556" y2="-170.906" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-22" x1="22.676" y1="-17.403" x2="212.124" y2="-170.358" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-23" x1="30.707" y1="-13.522" x2="280.963" y2="-129.69" xlink:href="#linear-gradient-14"/>
    <linearGradient id="linear-gradient-24" x1="0.159" y1="0.741" x2="0.802" y2="0.304" xlink:href="#linear-gradient-14"/>
  </defs>
  <g id="Group_594" data-name="Group 594" transform="translate(-136.018 -345.826)">
    <path id="Path_2291" data-name="Path 2291" d="M338.042,351.767h-5.995v1.9a3.6,3.6,0,0,1-.931,2.394,3.66,3.66,0,0,1-2.92.994l-8.519.01v6.011c1.908-.012,6.751-.024,8.659-.037a10.265,10.265,0,0,0,2.769-.349,9.437,9.437,0,0,0,5.276-3.43,8.622,8.622,0,0,0,1.656-4.453c.056-.854,0-1.73,0-2.586Z" transform="translate(-85.793 -2.775)" fill="url(#linear-gradient)"/>
    <rect id="Rectangle_288" data-name="Rectangle 288" width="5.899" height="22.815" transform="translate(237.742 363.07)" fill="url(#linear-gradient)"/>
    <rect id="Rectangle_289" data-name="Rectangle 289" width="5.899" height="22.815" transform="translate(180.694 363.07)" fill="url(#linear-gradient-3)"/>
    <g id="Group_589" data-name="Group 589" transform="translate(136.018 363.105)">
      <path id="Path_2292" data-name="Path 2292" d="M174.783,382.847v-.064h-6.057v.155h0V394.9c-.45.026-.7.053-.951.053q-6.65-.026-13.3-.058l-4.665-.02-.526,0v0l-3.328,0a3.6,3.6,0,0,1-2.92-1.028,3.793,3.793,0,0,1-.931-2.474c-.044-1.245-.046-2.471,0-3.715a3.6,3.6,0,0,1,.931-2.394,3.661,3.661,0,0,1,2.92-.994l5.079-.006v-6c-1.959.007-4.1.015-5.219.022a10.28,10.28,0,0,0-2.769.349,9.443,9.443,0,0,0-5.277,3.43,8.625,8.625,0,0,0-1.656,4.453,47.732,47.732,0,0,0,0,6.036,9.1,9.1,0,0,0,1.656,4.6,9.4,9.4,0,0,0,5.277,3.545,9.931,9.931,0,0,0,2.769.36c.631,0,1.586.009,2.648.013,0,.006,0,.011,0,.016l2.619-.006c1.352.005,3.39-.009,3.39-.009l20.312-.05V382.847Z" transform="translate(-136.018 -378.253)" fill="url(#linear-gradient-3)"/>
    </g>
    <rect id="Rectangle_290" data-name="Rectangle 290" width="6.055" height="6.055" transform="translate(151.391 388.433)" fill="url(#linear-gradient-3)"/>
    <rect id="Rectangle_291" data-name="Rectangle 291" width="6.055" height="6.055" transform="translate(160.171 388.433)" fill="url(#linear-gradient-3)"/>
    <rect id="Rectangle_292" data-name="Rectangle 292" width="6.055" height="6.055" transform="translate(168.77 388.433)" fill="url(#linear-gradient-3)"/>
    <rect id="Rectangle_293" data-name="Rectangle 293" width="6.055" height="6.055" transform="translate(217.94 388.433)" fill="url(#linear-gradient-3)"/>
    <rect id="Rectangle_294" data-name="Rectangle 294" width="6.055" height="6.055" transform="translate(212.49 354.947)" fill="url(#linear-gradient-3)"/>
    <rect id="Rectangle_295" data-name="Rectangle 295" width="6.055" height="6.055" transform="translate(226.72 388.433)" fill="url(#linear-gradient-3)"/>
    <path id="Path_2293" data-name="Path 2293" d="M280.507,383.243l-6.126.08q.041,4.076.082,8.151a4.21,4.21,0,0,1-.791,2.527,3.965,3.965,0,0,1-1.906,1.339,13.632,13.632,0,0,1-4.435.431h-.038s-.695,0-.695-.011c-.043.007-.09.006-.133.011H266.2a9.466,9.466,0,0,0,.773-3.762c0-1.449.012-2.9.014-4.348s0-2.874,0-4.419l-6.126.08q.041,4.076.082,8.151a4.108,4.108,0,0,1-1.014,2.791,3.629,3.629,0,0,1-1.648,1.063,5.507,5.507,0,0,1-1.08.257c-.47.065-.944.1-1.417.131-.457.031-.915.076-1.373.066-.3-.006-.539-.012-.539-.011V390.95q0-.536-.007-1.071a10.266,10.266,0,0,0-.348-2.769,9.441,9.441,0,0,0-3.43-5.276,8.622,8.622,0,0,0-4.453-1.656c-.854-.056-1.73,0-2.585,0H238.9v5.995h.039v.024c1.021.031,2.042,0,3.063-.024h2.493a3.6,3.6,0,0,1,2.394.931,3.664,3.664,0,0,1,.994,2.92l.011,5.738-8.869.036v6.06l15.683.082c.419-.011,1.018-.042,1.732-.131.411-.051.893-.111,1.422-.2.419-.058.833-.128,1.229-.217A9.913,9.913,0,0,0,266,396.208l.03-.051v5.763s4.106,0,4.106,0a10.864,10.864,0,0,0,2.508-.247,9.818,9.818,0,0,0,7.851-9.659c0-1.449.011-2.9.014-4.348S280.507,384.788,280.507,383.243Z" transform="translate(-48.058 -16.035)" fill="url(#linear-gradient-3)"/>
